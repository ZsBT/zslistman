...
CREATE table voting(id integer AUTO_INCREMENT primary key, name varchar(100) not null, fromts timestamp not null default CURRENT_TIMESTAMP, tots timestamp not null, selections text default '[]');
